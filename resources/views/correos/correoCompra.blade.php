                                        ...
                                        <div class="row" style="padding-bottom: 1%">
                                            <div class="col-md-6">
                                                <div style="padding-left: 10%;">
                                                    ...
                                                    @if($pedido->tipoPago == "Paypal")
                                                        <img src="{{ asset('storage/imagenesLayout/paypal.png')}}" alt="PaypalLogo" width=160>
                                                    @elseif($pedido->tipoPago == "ConektaTarjeta")
                                                        <img src="{{ asset('storage/imagenesLayout/credits.png')}}" alt="Tarjetas" width=160>
                                                    @elseif($pedido->tipoPago == "ConektaOXXO")
                                                ...
                                                <tr>
                                                    <td width="50%" style="padding-right: 5px;">
                                                        <div class="opps-instructions" style="color: #7C7C7C; font-family: 'Arial'; font-size: 12px; ">
                                                            ...
                                                            <h3 style="margin-bottom: 2px;">*Recuerda pagar antes de {{date_format(date_create($pedido->fechaExpPago), 'd/m/Y H:i:s')}}</h3>
                                                        ...
                                                        <div class="opps-header">
                                                            ...
                                                            <div class="opps-info" style="font-family: 'Arial'">
                                                                                ...
                                                                                <div class="opps-ammount">
                                                                                    <h3>MONTO A PAGAR</h3>
                                                                                    <h2 style="margin-bottom: 2px; font-size: 28px">${{$pedido->total}} <sup style="color: #000; font-size: 18px">MXN</sup></h2>
                                                            ...
                                                            <div class="opps-reference" style="font-family:'Arial'">
                                                                ...
                                                                <h1 style="border: 1px solid #7C7C7C; text-align: center; padding: 4px 0; margin-top: 0px;">{{$pedido->referOXXO}}</h1>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
