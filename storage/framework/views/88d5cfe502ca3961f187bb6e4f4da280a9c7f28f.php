                ...
                <div class="col-10 col-md-5">
                  <div class="dropdown" id="cart">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      ...
                      <?php endif; ?>
                      <?php if(!(Auth::guard('cliente')->check() || Auth::check())): ?> <a class="dropdown-item" href="#" data-toggle="modal" data-target="#ModalLogin"><i class="fas fa-sign-in-alt"></i>   Iniciar Sesión</a><?php endif; ?>
            ...
            <div class="modal-body">
              <form role="form" action="<?php echo e(route('loginCliente')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="username" name="username" aria-describedby="usernamehelp" placeholder="Nombre de Usuario" autocomplete="off" value="<?php echo e(old('username')); ?>" required>
                </div>
                <div class="form-group">
