...
<div class="tab-pane fade show active" id="nav-admins" role="tabpanel" aria-labelledby="nav-admins-tab">
    <div class="row">
        ...
        <div id="add-admin">
            ...
            <form role="form" action="<?php echo e(route('registroAdmin')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div id="del-admin">
            <div id="del-admin-form">
                <?php echo $__env->make('widgets.admin.tablaAdmins', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
    </div>  
</div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <input type="hidden" value="<?php echo e(route('tablaAdmins')); ?>" id="rutaAdmins">
    <input type="hidden" value="<?php echo e(route('editAdmin')); ?>" id="rutaEditAdmin">
    <input type="hidden" value="<?php echo e(route('delAdmin')); ?>" id="rutaDelAdmin">
    <script src="<?php echo e(asset('js/admin/tabAdmins.js')); ?>"></script>    
<?php $__env->stopSection(); ?>
