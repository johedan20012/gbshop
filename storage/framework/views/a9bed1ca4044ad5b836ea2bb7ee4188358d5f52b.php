                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingThree">
                                                <li>
                                                    ...
                                                    <label for="">Transferencia Bancaria o depósito en Ventanilla<img src="<?php echo e(asset('storage/imagenesLayout/cah.jpeg')); ?>" alt="Conekta: Pago en Efectivo en OXXO" style="margin-top: -12px">	</label>
                                                </li>                                        
                                            </div>
