    ...
    <div class="row">
        ...
        <div id="del-marca">
            <div id="del-marca-form">
                <?php echo $__env->make('widgets.admin.tablaMarcas', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
        </div>
    </div>  
...
<?php $__env->startSection('scripts'); ?>
    ...
    ##parent-placeholder-16728d18790deb58b3b8c1df74f06e536b532695##
        <input type="hidden" value="<?php echo e(route('tablaMarcas')); ?>" id="rutaMarcas">
        <input type="hidden" value="<?php echo e(route('editMarca')); ?>" id="rutaEditMarca">
        <input type="hidden" value="<?php echo e(route('delMarca')); ?>" id="rutaDelMarca">
