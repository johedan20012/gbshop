<div class="row d-flex justify-content-between">
    <div class="row ml-3">
        <?php echo $admins->links('widgets.pagination'); ?>
...
<tbody>
    ...
    <?php $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <td class="nombre-admin"><?php echo e($admin->username); ?></td>
        <td>
            ...
            <div class="dropdown-menu">
                <button class="dropdown-item" data-toggle="modal" data-type="1" data-target="#modalAdmins" data-id="<?php echo e($admin->idadmins); ?>" data-nombre="<?php echo e($admin->username); ?>"><i class="fa fa-edit" style="color:blue"> </i> Cambiar contraseña</button>
                <div class="dropdown-divider"></div>
                <button class="dropdown-item" data-toggle="modal" data-type="2" data-target="#modalAdmins" data-id="<?php echo e($admin->idadmins); ?>" data-nombre="<?php echo e($admin->username); ?>"><i class="fa fa-times" style="color: red"> </i> Eliminar</button>
            </div>
            </div>
        </td>
        </tr>
